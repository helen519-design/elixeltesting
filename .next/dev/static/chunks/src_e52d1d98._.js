...
const canProceedFromStep = (step, state)=>{
    switch(step){
        ...
        case 'Q5':
            ...
            return !!(symptomDate && symptomDate.date && symptomDate.isConfirmed);
        case 'Q6':
        ...
        case 'Q7':
            ...
            if (!injury?.type) return false;
            // Validate based on injury type
            if (injury.type === 'sporting') {
                const sporting = injury.sporting;
                return !!(sporting?.sport && sporting?.country && sporting?.receivedDonation !== null && sporting?.receivedDonation !== undefined);
            }
            if (injury.type === 'trip_fall') {
                const tripFall = injury.tripFall;
                return !!(tripFall?.cause && tripFall?.country && tripFall?.wasWinterSport !== null && tripFall?.wasWinterSport !== undefined);
            }
            if (injury.type === 'traffic') {
                const traffic = injury.traffic;
                if (!traffic?.role || !traffic?.country) return false;
                if (traffic.criminalProceedings === null || traffic.criminalProceedings === undefined) return false;
                // Additional validation for motorcycle/bicycle role
                if (traffic.role === 'motorcycle_bicycle') {
                    return traffic.hadProtection !== null && traffic.hadProtection !== undefined;
                }
                // Additional validation for motor vehicle role
                if (traffic.role === 'motor_vehicle') {
                    return traffic.hadSeatbelt !== null && traffic.hadSeatbelt !== undefined;
                }
                // Pedestrian role - no additional fields required
                return true;
            }
            if (injury.type === 'attack') {
                const attack = injury.attack;
                return !!(attack?.cause && attack?.country);
            }
            if (injury.type === 'other') {
                // "Other" selection doesn't require additional fields
                return true;
            }
            return false;
        case 'Q8':
...
const Step7HowHappened = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$QuestionLayout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QuestionLayout"], {
        ...
        description: "To help us assist you better, please share more details about your situation. Select the option that best explains the cause of your injury, or feel free to add more information in the 'other' section.",
        children: [
    ...
    const options = [
        {
            label: 'NHS GP',
            value: 'nhs_gp',
            description: 'Yes, I have consulted an NHS GP'
        },
        {
            label: 'Private GP',
            value: 'private_gp',
            description: 'Yes, I have consulted a private GP'
        },
        {
            label: 'Self-referral',
            value: 'self_referral',
            description: 'No, I intend to do a self-referral'
        },
        {
            label: 'Fast-track consultation',
            value: 'fast_track',
            description: 'Yes, I have consulted the Fast Track service'
        },
        {
            label: 'Other',
            value: 'other',
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$QuestionLayout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QuestionLayout"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                referralDate.mode === 'exact' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$DatePicker$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DatePicker"], {
                    id: "referral-exact-date",
                    label: "Referral date",
                    value: referralDate.exactDate ?? '',
                    onChange: (value)=>handleDateChange('exactDate', value),
                    placeholder: "dd/mm/yyyy"
                }, void 0, false, {
                    fileName: "[project]/src/components/steps/Step10ReferralDate.tsx",
                    lineNumber: 72,
...
//# sourceMappingURL=src_e52d1d98._.js.map